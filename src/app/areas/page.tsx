  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-semibold text-gray-900 dark:text-white">Gestão de Áreas Técnicas</h1>
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Gerencie as áreas técnicas disponíveis no sistema.</p>
        </div>
        <button
          onClick={openCreate}
